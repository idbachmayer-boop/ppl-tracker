...
- [ ] 01-01-PLAN.md — Tracer: declare COLLECTIONS at the TDZ-safe spot, validate it at module eval, boot every schema through it; settle export columns/format (REG-17)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-02-PLAN.md — Derive blank(), the liveX() family and validateBackup() from COLLECTIONS, one commit each, legacy twins kept (REG-12 steps 1-3)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 01-03-PLAN.md — Freeze mergeDB as mergeDB_legacy, replay every sync incident, then derive mergeCollections(); gen early return untouched (REG-12 step 4)

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 01-04-PLAN.md — Seeded random merge differential + merge laws; .gitignore and the local-only real-backup differential that skips loudly

**Wave 5** *(blocked on Wave 4 completion)*

- [ ] 01-05-PLAN.md — sleep as one COLLECTIONS entry (SCHEMA 18), Care → Sleep log/list/delete, SLEEP-05 probe proof
- [ ] 01-06-PLAN.md — Checkpoint: Ian exports a real backup into test/local/; the real-data differential must PASS (counts-only record)
...
|-------|----------------|--------|-----------|
| 1. F1 — The COLLECTIONS Registry | 0/TBD | Not started | - |
